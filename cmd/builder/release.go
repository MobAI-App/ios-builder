...
func runIOSRelease(cmd *cobra.Command, _ []string) error {
	...
	opts := &release.Options{Build: buildOptionsFromFlags(cmd), AppStore: appStore, ReleaseType: releaseType}
...
func buildOptionsFromFlags(cmd *cobra.Command) build.BuildOptions {
